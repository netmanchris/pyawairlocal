...
import pyawairlocal.data
from pyawairlocal.client import AwairClient
import datetime


class AwairDev:
    def __init__(self, device_name: str, device_ip=None, auth: AwairClient, cache_time: float = 15,
        ...
        :param device_ip: The IP address of the device. If you are using DHCP in your local network this may change. Use Reservations.
        :param auth: The device client object as created by the AwairClient class.
        ...
        self._data = pyawairlocal.data.get_dev_data(self._auth)

#TODO CONTINUE BUILDING OUT THE OBJECT HERE LATER
